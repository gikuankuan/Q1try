	...
	<p class="t cent botli">選單管理</p>
		<form method="post" target="back" action="?do=tii">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><input type="button" value="編輯次選單" onclick="op('#cover','#cvr','modal/upload_title.php?id=<?= $row['id']; ?>&table=<?= $table; ?>')">
							</td>
			...
			<table style="margin-top:40px; width:70%;">
				<tbody>
					<tr>
						<td width="200px"><input type="button" onclick="op(&#39;#cover&#39;,&#39;#cvr&#39;,&#39;view.php?do=title&#39;)" value="新增主選單"></td>
